...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "emp/sal/empsalary/test/integration/FirstJourney",
    "emp/sal/empsalary/test/integration/EmployeesListJourney",
    "emp/sal/empsalary/test/integration/EmployeesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
